      ...
      {isLoading ? (
        <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="rounded-2xl border border-border p-6 bg-card shadow-soft space-y-3"
            >
            ...
            <div className="rounded-2xl border border-border bg-card p-6 shadow-soft">
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="flex justify-between items-center border-b border-border/50 pb-2">
                  ...
                  <span className="text-sm font-semibold">{profile?.userid ?? "—"}</span>
                </div>
                <div className="flex justify-between items-center border-b border-border/50 pb-2">
                ...
                {(role === "customer" || role === "boutique_owner") && (
                  <div className="flex justify-between items-center border-b border-border/50 pb-2">
                ...
                <div className="flex flex-col h-full justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Share your code to grow your network and earn rewards.
                    </p>
                    <div className="mt-6">
                      <div className="text-sm font-medium text-muted-foreground">
                        Your unique referral code
                      </div>
                      <div className="mt-1 font-mono text-3xl font-extrabold text-gradient-primary tracking-tighter">
          ...
          {isLoading ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={series}>
                ...
                <Tooltip
                  contentStyle={{ borderRadius: 8, border: "1px solid oklch(0.92 0.02 290)" }}
                />
                <Line
                  type="monotone"
                  dataKey="users"
